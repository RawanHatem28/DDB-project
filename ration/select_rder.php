    ...
    if (isset($input['card_number']) && !isset($input['products'])) {
        ...
        if ($result->num_rows === 1) {
            ...
            if ($result_products->num_rows > 0) {
                ...
                echo json_encode(["status" => "success", "card_number" => $card_number, "userData" => $userData, "products" => $products]);
            } else {
                echo json_encode(["status" => "success", "card_number" => $card_number, "userData" => $userData, "products" => []]); // لا توجد منتجات
            }
        } else {
